...
describe('StatsOverview', () => {
  ...
  it('renders stats overview correctly', () => {
    render(<StatsOverview playStyle={'SP'} {...mockProps} />);
  ...
  it('formats total flare skill with commas', () => {
    render(<StatsOverview totalFlareSkill={1000000} grade="SUN+++" playStyle={'SP'} />);
    expect(screen.getByText('1,000,000')).toBeInTheDocument();
  });

  it('updates when props change', () => {
    const { rerender } = render(<StatsOverview playStyle={'SP'} {...mockProps} />);
    ...
    rerender(<StatsOverview totalFlareSkill={85000} grade="SUN" playStyle={'SP'} />);
